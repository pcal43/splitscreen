...
set -x
#
# release.sh - Updated for your fork
#
# Build a new release, push it to github, publish to modrinth and optionally curseforge
#
set -eu
...
#
# Optionally publish to curseforge (comment out if you don't have a curseforge project)
#
